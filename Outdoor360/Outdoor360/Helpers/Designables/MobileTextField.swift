...
@IBDesignable
@objc open class MobileTextField : NKVPhonePickerTextField {
    ...
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        return CGRect(x:45, y:5, width:bounds.size.width, height:bounds.size.height);
    }
...
fileprivate extension MobileTextField {
