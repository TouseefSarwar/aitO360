...
//  Yentna_Guide
//
//  Created by Touseef Sarwar on 27/05/2019.
...
class PickerY: NSObject {
    
    static private let sharedInstance = PickerY()
    ...
    class func selectOption(title: String = "",
        ...
        let picker = PickerY.sharedInstance
...
extension PickerY: UIPickerViewDataSource, UIPickerViewDelegate {
